...
//    @Override
//    public List<EntityTypeEntity> add(@NonNull CommandEntityTypeAddMany command) {
...
//    }
    ...
    public <Entity extends BaseEntity, CommandAddMany extends CommandAddManyBase> List<Entity> add(CommandAddMany commandAddManyBase) throws Exception {
        ...
        return (List<Entity>) entityTypeRepository.saveAll(entityTypesToSave);
    }
